...
@WebServlet("/receivedrequest")
public class ReceivedRequestsServlet extends OptionsServlet {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        List<User> pendingReq=Users.listAllReceivedRequests(currentUser.get().getId());
