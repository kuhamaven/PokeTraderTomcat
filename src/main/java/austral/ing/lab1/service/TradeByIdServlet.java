...
@WebServlet("/tradebyid")
public class TradeByIdServlet extends OptionsServlet {

    @Override
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        Gson gson = new Gson();
        String[] tradeId = gson.fromJson(req.getReader(),String[].class);
        Trade trade= Trades.findById(Long.parseLong(tradeId[0])).get();
        ...
        String json = objectMapper.writeValueAsString(trade); //gson.toJson(cards);
